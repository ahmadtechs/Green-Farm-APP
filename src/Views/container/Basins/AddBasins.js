...
import {addBasin} from '../../../helpers/addBasin.helper'

 class AddBasins extends Component {
    constructor(props){
        super(props);
        this.state={
            anchorEl : null,
...
const mapDispatchToProps = (dispatch) => {
  return {
    addBasin: (userData)=> dispatch(addBasin(userData))
  }
}
export default connect(null, mapDispatchToProps)(withStyles(ActionsStyles, { withTheme: true })(AddBasins));